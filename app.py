...
st.markdown("Upload resumes and a job description to evaluate candidate fit with a weighted scoring system.")
...
uploaded_files = st.file_uploader("📂 Upload one or more resumes (DOCX only)", type=["docx"], accept_multiple_files=True)

if st.button("🚀 Run ATS Evaluation") and jd_text and uploaded_files:
    results = []
    ...
    # Leaderboard
    st.subheader("🏆 Multi-Resume Leaderboard")
